...
```text
project/conventions/nomenclature-blocs-pedagogiques.md
```
...
| ID | Type | Domaine | Titre | Version | Dernière modification | Statut | Source |
|---|---|---|---|---:|---|---|---|
| [GLO-IA-001] | Glossaire | IA | IA générative | 0.1 | 2026-06-11 | à créer | `project/glossaire/` |
| [GLO-CON-001] | Glossaire | CON | Connexion aux outils | 0.1 | 2026-06-11 | à créer | `project/glossaire/` |
| [GLO-MAP-001] | Glossaire | MAP | Cartographie de codebase | 0.1 | 2026-06-11 | à créer | `project/glossaire/` |
| [THE-MAP-001] | Théorie | MAP | Comprendre un codebase par cartographie | 0.1 | 2026-06-11 | à créer | `project/current/cours-ia-avance/` |
| [VIS-MAP-001] | Aide visuelle | MAP | Schéma fichiers, symboles et dépendances | 0.1 | 2026-06-11 | à créer | `project/current/cours-ia-avance/` |
| [THE-CON-001] | Théorie | CON | Pourquoi connecter un agent à des outils | 0.1 | 2026-06-11 | à créer | `project/current/cours-ia-avance/` |
| [EX-CON-001] | Exercice | CON | Identifier si une connexion à un outil est pertinente | 0.1 | 2026-06-11 | à créer | `project/current/cours-ia-avance/` |
