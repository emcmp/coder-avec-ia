...
- `[DOC-CHR-001]` Charte visuelle — v0.6 — convention de travail initiale
- `[DOC-CHR-002]` Charte rédactionnelle — v0.1 — convention de travail initiale
- `[DOC-CHR-003]` Charte pédagogique — v0.5 — convention de travail initiale
- `[DOC-CHR-004]` Nomenclature et bibliothèque du projet — v0.7 — convention de travail initiale
- `[DOC-CHR-005]` Gabarits pédagogiques — v0.4 — convention de travail initiale
...
- `[DOC-ADR-001]` ADR-0001 — Structure du dépôt — v0.1 — acceptée
