...
Il peut être fait en classe si le temps le permet, en exercice facultatif, en devoir court ou en activité de consolidation.
...
Il peut viser un cas plus complexe, une comparaison d’approches, une limite importante, un défi technique ou une réflexion critique.
